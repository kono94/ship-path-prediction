...
python ./deeprl/agents/curve_imitation.py --mode test --env curve-heading-speed-v0 --policy_path  bc_policy_heading_speed_circle_512_512.pth --animation_delay 0.15
