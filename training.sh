...
python ./deeprl/agents/ddpg/learn.py --mode test --file_prefix runs/4_400_300_5_666
# [(20, 80), (20, 80)]
exit 1
...
--replay_max_size 5000 --batch_size 128 \
--tau 0.001 --train_iter 30000  --reward_barrier 5 --step_barrier 1000 \
